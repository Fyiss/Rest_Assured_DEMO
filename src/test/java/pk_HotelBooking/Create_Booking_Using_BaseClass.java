...
public class Create_Booking_Using_BaseClass {
	@Test

	public static void createBooking() throws IOException, ParseException, org.json.simple.parser.ParseException{
		...
		Assert.assertEquals("Darshith", fname);
